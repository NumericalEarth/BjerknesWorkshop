...
#
# *Day 3 — differentiable atmospheric modelling with [Breeze.jl](https://github.com/NumericalEarth/Breeze.jl).*
#
...
# Ostashev & Wilson, *Acoustics in Moving Inhomogeneous Media* (2015) and
# Pierce, *Acoustics* (2019).
#
